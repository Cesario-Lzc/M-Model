...
[![Version](https://img.shields.io/badge/version-1.4.6-blue.svg)](https://github.com/Cesario-Lzc/M-Model)
...
**免费体验**：**所有账号均享 20 quota 终身体验额度**（注册即有，一次性赠送不按月重置，15 tool 全部可用，无需付费；轻量查询约可问 6 个问题）。

**升级 ProMax**：享 1000 quota / 30 天 + 15 tool 全量，价格以[官网会员页](https://mrmodel.cesario.top)公告为准。
