...
- **v1.5.9** (2026-09-22) — 反馈入口改指聊天室 + MCP 能力展示图
  - 🟡 MCP 面板反馈入口文案改为「欢迎登录官网进「聊天室」聊聊」（主人拍板：反馈沟通渠道主要是公共聊天室，底部导航 tab 一眼可见）
  - 🟡 公开仓新增 MCP 能力展示截图（assets/mcp-viz-showcase.png）：3 组 MCP 真实数据可视化（结构化观点追踪 + 多空情绪分布 + 平台热词趋势），放在 README 靠前位置
